          ...
          <div>
            ...
            <div v-if="store.presetMultiSelectActive" class="mb-3 flex items-center justify-between rounded-lg bg-blue-50 p-3">
              <div class="flex items-center space-x-2">
                ...
                <span v-if="store.selectedPresets.size > 0" class="text-sm text-gray-600">
                  ({{ store.selectedPresets.size }} {{ store.t('presetManager.selected') }})
                </span>
              </div>
              <button
            ...
            <div v-else class="space-y-2 max-h-96 overflow-y-auto">
              <div
                ...
                :class="{ 
                  ...
                  'bg-yellow-50 border-yellow-200': store.presetMultiSelectActive && store.selectedPresets.has(preset.id)
                }"
              >
                <div class="flex items-center flex-1">
                  ...
                  <div v-if="store.presetMultiSelectActive" class="mr-3">
                    <input
                      type="checkbox"
                      :checked="store.selectedPresets.has(preset.id)"
