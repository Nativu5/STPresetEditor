...
<template>
  <div id="app-container" class="flex flex-col h-screen bg-gray-100">
    ...
    <main class="flex flex-1 overflow-hidden">
      ...
      <aside class="w-1/4 bg-gray-50 p-4 overflow-y-auto border-r">
        <h2 class="text-lg font-semibold mb-4 sticky top-0 bg-gray-50 pb-2">Prompt Library</h2>
        <PromptLibrary />
      </aside>

      <!-- Main Editor View -->
      <section class="flex-1 p-4 overflow-y-auto">
        <h2 class="text-lg font-semibold mb-4 sticky top-0 bg-gray-100 pb-2">Editor</h2>
        <EditorView />
      </section>
